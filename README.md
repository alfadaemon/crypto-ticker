Cryptocurrency Ticker App, build it as a refreshment for my ReactJS knowledge. It is based on the tutorial found at https://sabe.io/tutorials/getting-started-with-react
